...
{
  // Source - https://stackoverflow.com/a/66187224
  // Posted by Simon Mourier, modified by community. See post 'Timeline' for change history
  ...
  public class FolderPicker
  {
    ...
    public List<string> ResultPaths => _resultPaths;
    public List<string> ResultNames => _resultNames;
    ...
    public virtual bool ForceFileSystem
    {
      get; set;
    }
    ...
    public virtual string OkButtonLabel
    {
      get; set;
    }
    public virtual string FileNameLabel
    {
      get; set;
    }
